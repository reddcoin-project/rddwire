...
// MsgVersion implements the Message interface and represents a Reddcoin version
...
// NewMsgVersion returns a new Reddcoin version message that conforms to the
...
// and local address from conn and returns a new Reddcoin version message that
