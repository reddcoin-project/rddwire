...
// MsgNotFound defines a Reddcoin notfound message which is sent in response to
...
// NewMsgNotFound returns a new Reddcoin notfound message that conforms to the
