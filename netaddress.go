...
// maxNetAddressPayload returns the max payload size for a Reddcoin NetAddress
...
type NetAddress struct {
	...
	// not present in the Reddcoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Reddcoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Reddcoin protocol mixes little and big endian.
