...
// MsgBlock implements the Message interface and represents a Reddcoin
...
// BtcDecode decodes from the Reddcoin wire protocol as it was sent across the
...
// the Reddcoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Reddcoin block message that conforms to the
