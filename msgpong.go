...
// MsgPong implements the Message interface and represents a Reddcoin pong
// message which is used primarily to confirm that a connection is still valid
// in response to a Reddcoin ping message (MsgPing).
//
...
// NewMsgPong returns a new Reddcoin pong message that conforms to the Message
