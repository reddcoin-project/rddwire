...
// MsgMemPool implements the Message interface and represents a Reddcoin mempool
...
// NewMsgMemPool returns a new Reddcoin pong message that conforms to the Message
