...
this package provides the rddwire.ProtocolVersion constant which indicates the
...
the following constants:
	...
	rddwire.MainNet
	rddwire.TestNet  (Regression test network)
	rddwire.TestNet3 (Test network version 3)
	rddwire.SimNet   (Simulation test network)
...
io.ErrShortWrite, or of type rddwire.MessageError.  This allows the caller to
